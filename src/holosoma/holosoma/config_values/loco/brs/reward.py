"""Locomotion reward presets for the BRS robot."""

from holosoma.config_types.reward import RewardManagerCfg, RewardTermCfg

brs_v1_loco = RewardManagerCfg(
        ...
        "pose": RewardTermCfg(
            ...
            params={
                "pose_weights": [
                    ...
                    1.0,   # left-hip-roll
                    0.01,  # left-hip-pitch
                    0.01,  # left-knee-pitch
                    5.0,   # left-ankle-roll
                    5.0,   # left-ankle-pitch
                    0.01,  # right-hip-yaw
                    1.0,   # right-hip-roll
                    0.01,  # right-hip-pitch
                    0.01,  # right-knee-pitch
                    5.0,   # right-ankle-roll
                    5.0,   # right-ankle-pitch
                ],
            },
            tags=["penalty_curriculum"],
        ),
