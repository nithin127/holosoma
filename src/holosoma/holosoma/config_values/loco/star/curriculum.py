"""Locomotion curriculum presets for the STAR robot."""

from holosoma.config_types.curriculum import CurriculumManagerCfg, CurriculumTermCfg

star_18dof_curriculum = CurriculumManagerCfg(
    params={
...
star_18dof_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
...
__all__ = ["star_18dof_curriculum", "star_18dof_curriculum_fast_sac"]
