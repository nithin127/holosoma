"""Locomotion reward presets for the STAR robot."""

from holosoma.config_types.reward import RewardManagerCfg, RewardTermCfg

star_18dof_loco = RewardManagerCfg(
...
star_18dof_loco_fast_sac = RewardManagerCfg(
    only_positive_rewards=False,
    terms={
        "tracking_lin_vel": RewardTermCfg(
            func="holosoma.managers.reward.terms.locomotion:tracking_lin_vel",
...
__all__ = ["star_18dof_loco", "star_18dof_loco_fast_sac"]
